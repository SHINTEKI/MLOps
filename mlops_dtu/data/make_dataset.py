...
def normalized_mnist():
    ...
    train_x = torch.cat((train_images_0, train_images_1, train_images_2, train_images_3, train_images_4, train_images_5)) # (30000,28,28)
    train_y = torch.cat((train_target_0, train_target_1, train_target_2, train_target_3, train_target_4, train_target_5)) # (30000,)
